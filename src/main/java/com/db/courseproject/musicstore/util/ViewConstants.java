...
public class ViewConstants {
    ...
    public static final String MAIN_FORM_FXML = "forms/MainForm.fxml";
    public static final String MAIN_FORM_TITLE = "Music store";

    public static final String ALBUM_CONTROLLER_FXML = "forms/Album.fxml";
    public static final String ALBUM_CONTROLLER_TITLE = "Albums";

    public static final String CREATE_UPDATE_ALBUM_CONTROLLER_FXML = "forms/CreateUpdateAlbum.fxml";
    public static final String CREATE_ALBUM_CONTROLLER_TITLE = "Create album";
    public static final String UPDATE_ALBUM_CONTROLLER_TITLE = "Update album";
